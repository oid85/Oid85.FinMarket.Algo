...
namespace Oid85.FinMarket.Algo.Application.Strategies
{
    public class MomentumMonthControlRiskLong(
        ...
        : Strategy
    {
        public new string Name { get; set; } = nameof(MomentumMonthControlRiskLong);

        public new string Description { get; set; } = "Momentum. Контроль риска. Только лонг. Раз в месяц";
