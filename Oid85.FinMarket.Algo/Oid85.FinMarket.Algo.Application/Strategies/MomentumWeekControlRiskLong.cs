...
namespace Oid85.FinMarket.Algo.Application.Strategies
{
    public class MomentumWeekControlRiskLong(
        ...
        : Strategy
    {
        public new string Name { get; set; } = nameof(MomentumWeekControlRiskLong);

        public new string Description { get; set; } = "Momentum. Контроль риска. Только лонг. Раз в неделю";
